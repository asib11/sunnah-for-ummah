              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 mx-auto w-full aspect-square">
                    {/* Visible orbit paths (dashed rings) — constrained inside card */}
                    <span className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[78%] h-[78%] rounded-full border border-dashed border-emerald-500/30" />
                    <span className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[98%] h-[98%] rounded-full border border-dashed border-emerald-400/25" />

                    {/* Soft green gradient backdrop behind the sun */}
                    <span className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[58%] h-[58%] rounded-[62%_38%_54%_46%/48%_56%_44%_52%] bg-[linear-gradient(135deg,hsl(152_55%_30%/0.18)_0%,hsl(140_60%_45%/0.18)_50%,hsl(165_70%_55%/0.18)_100%)]" />

                    {/* The "sun" — main product image (smaller so planets fit inside card) */}
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[55%] h-[55%] overflow-hidden rounded-[58%_42%_47%_53%/52%_44%_56%_48%] bg-muted ring-[1.5px] ring-emerald-500/70 shadow-[0_8px_30px_-8px_hsl(152_50%_30%/0.4)]">
                      <img
                        src={pkg.image}
                        alt={pkg.title}
                        loading="lazy"
                    ...
                    <div className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[78%] h-[78%]">
